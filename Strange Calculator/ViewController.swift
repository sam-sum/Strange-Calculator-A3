...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var landscapeStepLabel: UILabel!
    ...
    override func viewDidLoad() {
        ...
        landscapeResultLabel.text = Calculation.shared.getResult()
        landscapeStepLabel.text = Calculation.shared.getSteps(maxStepsChar)
    }
    ...
    @IBAction func btnNumbersUpInside(_ sender: UIButton) {
        ...
        landscapeStepLabel.text = steps
        landscapeResultLabel.text = result
        alignLabelText()
    }
